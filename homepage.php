...
<div class="info-section">
  <div class="info-box">
    ...
    <p>Join our community of caring parents! Sign up now to connect with the teachers and discover valuable resources for your little ones.</p>
    <button>Sign Up</button>
  </div>
  <div class="info-box">
    <h2>Find A Teacher</h2>
    <p>Need a trustworthy Teacher for your child? Explore our network of experienced caregivers ready to provide quality care when you need it.</p>
    <a href="find_babysitter.php" class="find-babysitter-btn-link">
    <button class="find-babysitter-btn">Find A Babysitter</button>
</a>
  </div>
  <div class="info-box">
    <h2>About</h2>
    ...
    <div class="step-container">
        ...
        <div class="step">
            ...
            <ul>
                ...
                <li>Pricing for families and the teachers</li>
            </ul>
        </div>
        <div class="step">
            <div class="step-icon">
