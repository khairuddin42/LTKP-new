...
<header class="navbar">
  <div class="navbar-brand">
    <img src="LTKP logo.jpg" alt="Little Thinkers Kota Puteri" class="logo"> <!-- Replace with your logo -->
...
<div class="contact-form-container">
    <h2>Contact us</h2>
    <p>Fill out the form below to contact us, or send an email to info@sitly.my</p>
