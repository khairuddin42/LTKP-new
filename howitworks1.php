...
<header class="navbar">
  ...
  <nav class="navbar-nav">
    ...
    <a href="Contact1.php" class="nav-link">Contacts</a>
...
<section class="how-it-works">
    <div class="container">
        <!-- Card 1 -->
        <div class="card">
            <img src="easy.webp" alt="Icon 1"> <!-- Replace with your actual icon path -->
        ...
        <!-- Card 2 -->
        <div class="card">
            <img src="safety.webp" alt="Icon 2"> <!-- Replace with your actual icon path -->
        ...
        <!-- Card 3 -->
        <div class="card">
            <img src="peace-of-mind.webp" alt="Icon 3"> <!-- Replace with your actual icon path -->
